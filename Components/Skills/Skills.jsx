          ...
          <h1 className=' text-4xl pb-16 lg:pb-10 flex justify-center pt-14 underline underline-offset-8 decoration-yellow-400 font-bold text-white'>SKILLS</h1>
              ...
              <div>
                <div className='flex w-full'>
                  ...
                  <h1 className='flex my-auto ml-6 pr-5'>99%</h1>
                  </div>
                  </Fade>
                  ...
                  <h1 className=' flex my-auto ml-6 pr-5'>90%</h1>
                  </div>
                  </Fade>
                  ...
                  <h1 className='flex my-auto ml-6 pr-5'>70%</h1>
                  </div>
                  </Fade>
                  ...
                  <h1 className='flex my-auto ml-6 pr-5'>85%</h1>
                  </div>
                  </Fade>
                  ...
                  <h1 className='flex my-auto ml-6 pr-5'>78%</h1>
                  </div>
                  </Fade>
                  </div>  
